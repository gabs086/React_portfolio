        ...
        <div className="container">
            ...
            <div className="col-sm-12">
              <div className="title-box text-center">
                ...
                <p className="subtitle-a">
                  View my works while learning how to code and while in the
          ...
          <div className="row">
            ...
            <div className="col-md-4">
              <div className="work-box">
                <div className="work-img">
                  <img src={soa} alt="" className="img-fluid" />
                </div>
            ...
            <div className="col-md-4">
              <div className="work-box">
                <div className="work-img">
                  <img src={divisoria} alt="" className="img-fluid" />
                </div>
                <div className="work-content">
                  <div className="row">
                    <div className="col-sm-8">
            ...
            <div className="col-md-4">
              <div className="work-box">
                <div className="work-img">
                  <img src={techniqo} alt="" className="img-fluid" />
                </div>
                <div className="work-content">
                  <div className="row">
                    <div className="col-sm-8">
            ...
            <div className="col-md-4">
              <div className="work-box">
                <div className="work-img">
                  <img src={gtsWebsite} alt="" className="img-fluid" />
                </div>
                <div className="work-content">
                  <div className="row">
                    <div className="col-sm-8">
                      ...
                      <div className="w-more">
                        <span className="w-ctegory">
                        HTML5 CSS3 JavaScript PHP JotForms Bootstrap
                        </span>
                      </div>
                    </div>
                    <div className="col-sm-4 text-center work-view">
            ...
            <div className="col-md-4">
              <div className="work-box">
                <div className="work-img">
                  <img src={gtsStore} alt="" className="img-fluid" />
                </div>
                <div className="work-content">
                  <div className="row">
                    <div className="col-sm-8">
            ...
            <div className="col-md-4">
              <div className="work-box">
                <div className="work-img">
                  <img src={zeus} alt="" className="img-fluid" />
                </div>
                <div className="work-content">
                  <div className="row">
                    <div className="col-sm-8">
                      ...
                      <div className="w-more">
                        <span className="w-ctegory">
                          Codeigniter MERN Material-UI Android Studio (Java)
                        </span>
                      </div>
                    </div>
                    <div className="col-sm-4 text-center work-view">
