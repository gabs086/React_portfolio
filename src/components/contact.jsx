...
import imageOverlay from '../img/overlay.png';
              ...
              <div id='contact' className='box-shadow-full'>
                <div className='row'>
                  <div className='col-md-6'>
                    ...
                    <div>
                      <form action='https://formspree.io/f/maylrdvr' method='POST' className='contactForm'>
                  ...
                  <div className='col-md-6'>
                    ...
                    <div className='socials'>
                      <ul>
                        <li>
                          <a href='https://github.com/gabs086' target='_blank' rel='noopener noreferrer'>
